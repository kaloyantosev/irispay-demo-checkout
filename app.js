...
const translations = {
  bg: {
    ...
    methodTransferDesc: 'ръчно въвеждане и бавен процес',
    methodCodDesc: 'забавени плащания и високи такси',
  ...
  en: {
    ...
    methodTransferDesc: 'manual input and slow process',
    methodCodDesc: 'delayed payments and high fees',
  ...
  ro: {
    ...
    methodTransferDesc: 'introducere manuală și proces lent',
    methodCodDesc: 'plăți întârziate și comisioane mari',
  ...
  hr: {
    ...
    methodTransferDesc: 'ručni unos i spori proces',
    methodCodDesc: 'odgođena plaćanja i visoke naknade',
  ...
  gr: {
    ...
    methodTransferDesc: 'μη αυτόματη εισαγωγή και αργή διαδικασία',
    methodCodDesc: 'καθυστερημένες πληρωμές και υψηλές χρεώσεις',
  ...
  it: {
    ...
    methodTransferDesc: 'inserimento manuale e processo lento',
    methodCodDesc: 'pagamenti ritardati e commissioni elevate',
